...
<img src="animated/light_1.gif" height="20px" />  I am a Full Stack Developer with engineering experience specializing in Front-end as well as in Back-end, Dev-Ops and Cloud. I like doing cool things like exploring recent tools in the software industry, writing technical articles on Web.dev, and participating in coding competitions. I have hands-on experience in developing large-scale production-level apps. and introducing new processes that helped achieve faster quality results.
...
-    📜 **5+ certifications** from various learning platforms like _LinkedIn, Udemy, Coursera_
-    👩🏼‍💻 **10+ project repos** in _Github_
